...
- **IF AND ONLY IF** your reasoning for an unprotected access is **EXACTLY THE SAME** as for the previous one, you can write "Same as above" in place of your reasoning, to save space.
